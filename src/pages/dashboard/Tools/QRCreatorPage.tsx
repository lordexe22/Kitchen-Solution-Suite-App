...
// #component QRCreatorPage - Generador de códigos QR
/**
 * Página para crear códigos QR de sucursales y mesas.
 * Permite seleccionar una compañía y sucursal, luego generar un QR
 * que redirija a la vista de cliente de esa sucursal.
 */
