 ...
 *
 * @context
 * Utilizado por RequestConfig y por las funciones del módulo httpClient del sistema.
 *
 * @since 1.0.0
 *
 ...
 *
 * @context
 * Utilizado por las funciones de petición del módulo httpClient del sistema.
 *
 * @since 1.0.0
 *
 * @author Walter Ezequiel Puig
 ...
 *
 * @context
 * Utilizado internamente por el módulo httpClient del sistema.
 *
 ...
 *
 * @context
 * Utilizado al inicializar una instancia del cliente HTTP en el módulo del sistema.
 *
 * @since 1.0.0
 *
 * @author Walter Ezequiel Puig
 ...
 *
 * @context
 * Registrado en el cliente HTTP del sistema para modificar peticiones salientes.
 *
 * @since 1.0.0
 *
 * @author Walter Ezequiel Puig
 ...
 *
 * @context
 * Registrado en el cliente HTTP del sistema para procesar respuestas entrantes.
 *
 * @since 1.0.0
 *
 * @author Walter Ezequiel Puig
 ...
 *
 * @context
 * Registrado en el cliente HTTP del sistema para interceptar errores de peticiones.
 *
 * @since 1.0.0
 *
 * @author Walter Ezequiel Puig
